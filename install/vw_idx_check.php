<?php // $Id: vw_idx_check.php 4304 2006-06-05 14:53:06Z gregorerhardt $

global $cfgDir, $cfgFile, $failedImg, $filesDir, $locEnDir, $okImg, $tblwidth, $tmpDir, $cacheDir, $baseDir;
...
$cacheDir = isset($cacheDir) ? $cacheDir : "$baseDir/files/cache";
...
?>
<tr>
	<td class="item">./files/cache writable?</td>
	<td align="left"><?php echo is_writable($cacheDir) ? '<b class="ok">'.$okImg.'</b>'.$okMessage : '<b class="error">'.$failedImg.'</b><span class="warning"> caching will be disabled</span>';?></td>
</tr>
<?php
$okMessage="";
...
<tr>
	...
	method results in better software, with a lower Total Cost of Ownership (TCO).</p>
