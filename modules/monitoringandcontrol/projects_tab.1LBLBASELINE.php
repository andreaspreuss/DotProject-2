...
<!-- ***************** LISTA ATAS ****************************-->	
   <br/>
    <p align="right" style="width:85%"> 
         <a href="?m=monitoringandcontrol&a=addedit_baseline&project_id=<?php echo $project_id ; ?>"><input type="button" class="button" value="<?php echo $AppUI->_('LBL_NOVA').' '.$AppUI->_('LBL_BASELINE'); ?>" ></a> 
    </p>

   <table class="std"  width="70%" align="center" style="border-radius:6px">	
