...
<!-- *************  LISTA  ************ -->	
	<br/>
	<table class="std" id="tb_costList" width="70%" align="center" style="border-radius:6px">	
		<tr>
			<th style="width:32%"><?php echo $AppUI->_('LBL_INICIO_VIGENCIA');?> </th>
			<th style="width:32%"><?php echo $AppUI->_('LBL_FIM_VIGENCIA');?></th>
			<th style="width:32%"><?php echo $AppUI->_('LBL_TAXA_PADRAO');?></th>
			<th style="width:2%">&nbsp;</th>
			<th style="width:2%">&nbsp;</th>
         </tr>		
...
<?php
    ...
    <?php   
			...
			echo "<script>var globalData = new Array(); 
						  var index = 0; 
				  </script>";	
	...
	<table class="std" id="tb_updateRow" width="70%" align="center" style="border-radius:6px">	
		<tr>
			<th style="width:32%"><?php echo $AppUI->_('LBL_INICIO_VIGENCIA');?> </th>
			<th style="width:32%"><?php echo $AppUI->_('LBL_FIM_VIGENCIA');?></th>
			<th style="width:36%"><?php echo $AppUI->_('LBL_TAXA_PADRAO');?></th>		
         </tr>		
		  <tr>
...
<!-- ************ ADD CADASTRO  ************ -->	
	...
	<table class="std" id="tb_addCosts" width="70%" align="center" style="border-radius:6px">	
	...
	<table width="70%" align="center">
		<tr>
			<td>				
				<input type="button" class="button"  onclick="return valida();" value="Save" />
			</td>
		</tr>
	</table>
</form>
