...
$titleBlock = new CTitleBlock($res->fields['company_name'] . ' policies', 'applet3-48.png', $m, "$m.$a");
...
<td align='center'>
  <table>
  <tr><td align='right'><?php echo $AppUI->_('Rewards and recognition'); ?></td>
  ...
  <tr><td align='right'><?php echo $AppUI->_('Regulations, standards, and policy compliance'); ?></td>
  <td><textarea name='company_policies_policy' cols="90" rows="8"><?php echo dPformSafe($policies->company_policies_policy);?></textarea></td>
  <tr><td align='right'><?php echo $AppUI->_('Safety'); ?></td>
...
<tr>
  <td align="right">
    ...
    class="button" onclick="submitPolicies(document.editfrm);"/>
  </td>
</tr>
</table>
</form>
