...
$titleBlock->addCrumb(('?m=projects&amp;a=view&amp;project_id=' . $project_id), 'project ' . $res_project->fields['project_name']);
$titleBlock->addCrumb(('?m=tasks&amp;a=view&amp;task_id=' . $task_id), 'task ' . $res_task->fields['task_name']);
$titleBlock->show();
