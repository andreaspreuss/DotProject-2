...
if($allocated_user_id || $human_resource_allocation_id) {
	...
	if(count($human_resource_tasks) == 0) {
		echo '<br><font color="#319457"> That user is not allocated to any other task. </font>
				<img src="/dotproject/modules/human_resources/images/ok.png" title="Ok" alt="Ok"/><br><br>';
	}
	else {
		echo '<br>';
		?>
		...
		<?php	
		echo '<br>';
		echo '<img src="./modules/human_resources/images/not.png" title="Conflict" alt="Conflict"/> : Tasks with date conflict &nbsp;&nbsp;&nbsp;';
		echo '<img src="./modules/human_resources/images/ok.png" title="Ok" alt="Ok"/> : Tasks with no date conflict';
		echo '<br><br>';
	}
}
?>
