...
$titleBlock->addCrumb(('?m=projects&amp;a=view&amp;project_id=' . $project_id), 'project ' . $project_name);
$titleBlock->addCrumb(('?m=tasks&amp;a=view&amp;task_id=' . $task_id), 'task ' . $task->task_name);

if($human_resource_allocation_id) {
	$canDelete = true;
	$titleBlock->addCrumb("?m=human_resources&amp;a=addedit_allocation&amp;human_resource_allocation_id=$human_resource_allocation_id&amp;project_tasks_estimated_roles_id=$project_tasks_estimated_roles_id&amp;task_id=$task_id&amp;project_id=$project_id", "edit this allocation");
	$titleBlock->addCrumbDelete('delete allocation', $canDelete, 'no delete permission');
}
else {
...
<script type="text/javascript" language="javascript">
	can_delete = true;
	delete_msg = "<?php echo $AppUI->_('doDelete').' '.$AppUI->_('Allocation').'?';?>";
</script>
