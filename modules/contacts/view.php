<?php /* CONTACTS $Id: view.php 6200 2013-01-15 06:24:08Z ajdonnison $ */
...
<?php } ?>
		...
		<tr>
			...
			<td nowrap="nowrap"><a href="mailto:<?php echo $AppUI->___(@$row->contact_email);?>"><?php 
								echo $AppUI->___(@$row->contact_email);?></a></td>
		</tr>
		<tr>
			<td align="right"><?php echo $AppUI->_('Email');?>2:</td>
			<td nowrap="nowrap"><a href="mailto:<?php echo $AppUI->___(@$row->contact_email2);?>"><?php 
								echo $AppUI->___(@$row->contact_email2);?></a></td>
		</tr>
		<tr>
			<td align="right"><?php echo $AppUI->_('URL');?>:</td>
			<td nowrap="nowrap"><a href="<?php echo $AppUI->___(@$row->contact_url);?>"><?php 
