...
// Ver:		$Id: jpgraph.php,v 1.1 2004/01/05 21:31:30 ajdonnison Exp $
//
...
class Image {
	...
	*/
	...
	if( $this->font_family >= FF_FONT0 && $this->font_family <= FF_FONT2+1) {	
//	    $this->_StrokeBuiltinFont($x,$y,$txt,$dir,$paragraph_align,$debug); //Andrew
	    $this->SetFont(FF_TIMES,FS_BOLD);
//            $this->font_family = FF_TIMES; //Andrew
