<?php /* TASKS $Id: todo.php 6188 2012-11-20 00:07:39Z ajdonnison $ */
...
// If the date is set we are being called from another context,
// and $this_day will be set.  If we are being called directly, it won't.
if ($date) {
