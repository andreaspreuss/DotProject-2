...
$riskDuration = array(1=>$AppUI->_('Hours'), 24=>$AppUI->_('Days'), 168=>$AppUI->_('Weeks'));
...
<form name="editrisk" action="?m=risks" method="post">
	...
	<input type="hidden" name="risk_id" value="<?php echo $risk_id;?>" />
      ...
      <?php echo arraySelect($tasks, 'risk_task', 'size="1" class="text"', $risk['risk_task']); ?>
		...
		<tr>
			<td>
				<input class="text" type="submit" value="<?php echo $AppUI->_('back'); ?>">
			</td>
			<td align="right">
				<input class="text" type="submit" value="<?php echo $AppUI->_('submit'); ?>">
			</td>
		</tr>
</form>
</table>
