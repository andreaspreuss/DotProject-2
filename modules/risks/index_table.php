...
<tr>
    ...
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_id" class="hdr"><?php echo $AppUI->_('LBL_ID');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_name" class="hdr"><?php echo $AppUI->_('LBL_NAME');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_description" class="hdr"><?php echo $AppUI->_('LBL_DESCRIPTION');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_probability" class="hdr"><?php echo $AppUI->_('LBL_PROBABILITY');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_impact" class="hdr"><?php echo $AppUI->_('LBL_IMPACT');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_priority" class="hdr"><?php echo $AppUI->_('LBL_PRIORITY');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_status" class="hdr"><?php echo $AppUI->_('LBL_STATUS');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_responsible" class="hdr"><?php echo $AppUI->_('LBL_OWNER');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_project" class="hdr"><?php echo $AppUI->_('LBL_PROJECT');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_task" class="hdr"><?php echo $AppUI->_('LBL_TASK');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_potential_other_projects" class="hdr"><?php echo $AppUI->_('LBL_POTENTIAL');?></a></th>
    <th nowrap="nowrap"><a href="<?php if ($projectSelected!=null) { echo '?m=projects&a=view&project_id='.$projectSelected.'tab='.$t; }else{ echo '?m=risks';} ?>&orderbyy=risk_strategy" class="hdr"><?php echo $AppUI->_('LBL_STRATEGY');?></a></th>
</tr>
<?php foreach ($activeList as $row) {
?>
<tr>
    <td nowrap style="background-color:#<?php echo $bg; ?>">
        <a href="index.php?m=risks&a=addedit&id=<?php echo($row['risk_id']); if ($projectSelected!=null) {echo('&project_id=' . $projectSelected . '&tab='. $t);}?>">
            <img src="./modules/risks/images/stock_edit-16.png" border="0" width="12" height="12">
        </a>
        <a href="index.php?m=risks&a=view&id=<?php echo($row['risk_id']); if ($projectSelected!=null) {echo('&project_id=' . $projectSelected . '&tab='. $t);}?>">
    ...
    <td style="background-color:#<?php if ($row['risk_priority']==0) {echo $bgGreen;} else { if ($row['risk_priority']==1) {echo $bgYellow;} else { if ($row['risk_priority']) {echo $bgRed;}}}?>"><?php echo  $riskPriority[$row['risk_priority']] ?></td>
