...
if ($v == null) {
    ?>
    <div align="right">
        <input class="button" type="button" name="new budget" value="new budget" onclick="location.href = '?m=costs&amp;a=view_budget&amp;project_id=<?php echo $projectSelected ?>';" />
    </div>
    <?php
} else {
    ?>
    <div align="right">
        <input class="button" type="button" name="edit budget" value="edit budget" onclick="location.href = '?m=costs&amp;a=view_budget&amp;project_id=<?php echo $projectSelected ?>&budget_id=<?php echo $projectSelected ?>';" />
    </div>
    <?php
}
?>
...
<?php echo $AppUI->_('Budget'); ?>
    ...
    <tr>
        <td nowrap="nowrap"><?php echo $v->fields['budget_reserve_management'] ?></td>
