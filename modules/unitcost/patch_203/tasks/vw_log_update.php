<?php /* TASKS $Id: vw_log_update.php,v 1.1.1.1 2006/08/16 06:50:06 aimass Exp $ */
GLOBAL $AppUI, $task_id, $obj, $percent, $can_edit_time_information;

/* unitcost module patch start */

GLOBAL $task_costs, $baseDir;
...
original code end -->
        ...
        <input onblur="javascript:changedValue('task_percent_complete')" type="text" id="task_percent_complete" name="task_percent_complete" value="<?php echo $obj->task_percent_complete ? $obj->task_percent_complete : 0;?>" class="text" maxlength="5" size="5" />
...
<!-- unitcost module patch start -->
        ...
        <tr>
          <td colspan="2" align="center" bgcolor="#FFFFFF">
            <?php echo $AppUI->_("Unit Cost Report") ?>
          </td>
        <tr>
          <td align='right'>
          ...
          <td>
	    <input type="text" name="unit_of_measure" id="unit_of_measure" value="<?php echo $task_costs->unit_of_measure ? $task_costs->unit_of_measure : 'N/A' ?>" class="text" disabled="disabled" size="3"/>
          </td>
        </tr>
        <tr>
          <td align='right'>
            <?php echo $AppUI->_("Accumulated Task Cost"); ?>
          </td>
          <td>
	    <input type="text" name="v_new_actual_cost" id="v_new_actual_cost" value="<?php echo $task_costs->task_actual_cost ? $task_costs->task_actual_cost : 0 ?>" class="text" disabled="disabled" size="18"/>
            <input type="hidden" name="new_actual_cost" id="new_actual_cost" value="<?php echo $task_costs->task_actual_cost ?>">
          </td>
        </tr>
        <tr>
          <td align='right'>
            <?php echo $AppUI->_("Accumulated Units made"); ?>
          </td>
          <td>
            <input onblur="javascript:changedValue('new_actual_units')" type="text" name="new_actual_units" id="new_actual_units" value="<?php echo $task_costs->task_actual_units ? $task_costs->task_actual_units : 0 ?>" class="text" size="12"/>
          </td>
        </tr>

        <input type="hidden" name="total_unit_cost" id="total_unit_cost" value="<?php echo $task_costs->total_unit_cost ?>">
        <input type="hidden" name="total_units" id="total_units" value="<?php echo $task_costs->total_units ?>">
