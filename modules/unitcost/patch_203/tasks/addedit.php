<?php /* TASKS $Id: addedit.php,v 1.1.1.1 2006/08/16 06:50:17 aimass Exp $ */
/**
* Tasks :: Add/Edit Form
*
*/
		...
		<tr>
			...
			<td>
				...
				<?php echo arraySelect( $percent, 'task_percent_complete', 'size="1" class="text"', $obj->task_percent_complete ) . '%';?>
                                original code end -->
                                <input type="text" id="task_percent_complete" name="task_percent_complete" value="<?php echo $obj->task_percent_complete ? $obj->task_percent_complete : 0;?>" disabled="disabled" class="text" maxlength="5" size="5" />
