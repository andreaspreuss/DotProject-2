<?php /* TASKS $Id: tasks.class.php,v 1.1.1.1 2006/08/16 06:50:15 aimass Exp $ */
...
// percent complete
	...
	// no more integer value
	$s .= "\n\t<td align=\"right\">".$a["task_percent_complete"].'%</td>';
	/* unitcost module patch end */
