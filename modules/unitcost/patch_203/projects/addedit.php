<?php /* PROJECTS $Id: addedit.php,v 1.1.1.1 2006/08/16 06:50:20 aimass Exp $ */
		...
		<tr>
			...
			<td>
				...
				<input type="text" name="project_actual_budget" value="<?php echo @$row->project_actual_budget;?>" size="10" maxlength="10" class="text"/>
                                orginal code end -->
				<input type="text" name="project_actual_budget" value="<?php echo @$row->project_actual_budget;?>" disabled="disabled" size="10" maxlength="10" class="text"/>
