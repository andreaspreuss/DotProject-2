<?php /* PROJECTS $Id: view.php,v 1.1.1.1 2006/08/16 06:50:19 aimass Exp $ */
...
/*
  For some reason this file does not use the project class which is
  patched by the unitcost module. Since we don't want to work double
  we will use it here.
*/

require_once $AppUI->getModuleClass('projects');
$unitcost_project = new CProject;
$unitcost_project->load($project_id);
$project_c_percent_complete = $unitcost_project->project_c_percent_complete;
...
<!-- unicost module patch start -->

		</tr>
		<tr>
			<td align="right" nowrap><?php echo $AppUI->_('CProgress');?>:</td>
			<td class="hilite" width="100%"><?php printf( "%.1f%%", $project_c_percent_complete );?></td>
		</tr>

<!-- unicost module patch end -->
